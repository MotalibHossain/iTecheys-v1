                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6" key={index}>
                            <div className="post-card pb-0">
                                <div className="post-card-img">
                                    ...
                                    <img src="https://images.ctfassets.net/hrltx12pl8hq/7yQR5uJhwEkRfjwMFJ7bUK/dc52a0913e8ff8b5c276177890eb0129/offset_comp_772626-opt.jpg?fit=fill&w=800&h=300" alt="post image" />
                                </div>
                                <div className="post-card-body">
                                    ...
                                    <div className="post">
                                        <h5 className="post-title mt-2">
                                            ...
                                            {/* <Link to={Item.title} state={{ id, title, description }}> */}
                                                <TextTruncate
                                                    line={1}
                                                    element="span"
                                                    truncateText="........"
